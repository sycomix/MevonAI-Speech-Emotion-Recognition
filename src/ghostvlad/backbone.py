...
def identity_block_2D(input_tensor, kernel_size, filters, stage, block, trainable=True):
    ...
    conv_name_1 = f'conv{str(stage)}_{str(block)}_1x1_reduce'
    bn_name_1 = f'conv{str(stage)}_{str(block)}_1x1_reduce/bn'
    ...
    conv_name_2 = f'conv{str(stage)}_{str(block)}_3x3'
    bn_name_2 = f'conv{str(stage)}_{str(block)}_3x3/bn'
    ...
    conv_name_3 = f'conv{str(stage)}_{str(block)}_1x1_increase'
    bn_name_3 = f'conv{str(stage)}_{str(block)}_1x1_increase/bn'
...
def conv_block_2D(input_tensor, kernel_size, filters, stage, block, strides=(2, 2), trainable=True):
    ...
    conv_name_4 = f'conv{str(stage)}_{str(block)}_1x1_proj'
    bn_name_4 = f'conv{str(stage)}_{str(block)}_1x1_proj/bn'
